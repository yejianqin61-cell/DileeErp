...
> 2026-09-16 更新：上面第二条已不成立 —— 确认即记账之后，「登记收款/付款」是同一笔钱的第二个入口
> （会把同一笔款/同一笔应付算两次），因此两个「确认」页只保留「勾选 + 批量确认」，
> 台账也不再列「已收/已付、未收/未付」。见 `finance-batch-confirm-and-copy-trim-2026-09-16.md`。
