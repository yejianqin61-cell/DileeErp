...
export class AuthController {
  ...
  @Get("me") @Header("Cache-Control", "no-store, no-cache, must-revalidate") async me(@Req() request: Request) { return { data: await this.auth.currentUser(request.cookies?.dilee_session), meta: {} }; }
