...
class UpdateReturnDto { @IsOptional() @IsString() quantity?: string; @IsOptional() @IsString() @MaxLength(500) product_description?: string; @IsOptional() @IsString() @MaxLength(1000) remark?: string; }
class UpdateDirectShipmentDto { @IsOptional() @IsString() quantity?: string; @IsOptional() @IsString() @MaxLength(500) product_description?: string; @IsOptional() @IsString() @MaxLength(500) logistics_reference?: string; @IsOptional() @IsString() @MaxLength(1000) remark?: string; }
...
export class OutsourceLogisticsController {
  ...
  @Patch("returns/:id") @RequireModules("warehouse") async updateReturn(@Param("id") id: string, @Body() body: UpdateReturnDto, @CurrentUser() user: CurrentUserType) { return { data: await this.logistics.updateReturn(id, body, user), meta: {} }; }
  ...
  @Patch("direct-shipments/:id") @RequireModules("warehouse") async updateDirectShipment(@Param("id") id: string, @Body() body: UpdateDirectShipmentDto, @CurrentUser() user: CurrentUserType) { return { data: await this.logistics.updateDirectShipment(id, body, user), meta: {} }; }
