...
class BatchEmployeeDailyReportsDto { @IsString() production_order_id!: string; @IsString() production_order_operation_id!: string; @IsDateString() report_date!: string; @IsString() rows!: string; }
