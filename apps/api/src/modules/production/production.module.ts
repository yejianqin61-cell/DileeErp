...
@Module({ imports: [AuditModule], controllers: [ProductionMasterDataController, ProductionOrdersController, RawMaterialMovementsController, OperationDailyReportsController, EmployeeDailyReportsController, ProductionDailyAlertsController, OutsourceLogisticsController, ProductionProgressController, FinishedGoodsQcController, FinishedGoodsInventoryController, FinishedGoodsOutboundController, ProductionPayrollExportController, MaterialSlipExportController], providers: [ProductionMasterDataService, ProductionOrdersService, RawMaterialMovementsService, OperationDailyReportsService, EmployeeDailyReportsService, ProductionDailyAlertsService, OutsourceLogisticsService, ProductionProgressService, FinishedGoodsQcService, FinishedGoodsInventoryService, FinishedGoodsOutboundService, ProductionPayrollExportService, MaterialSlipExportService], exports: [ProductionMasterDataService, ProductionOrdersService, RawMaterialMovementsService, OperationDailyReportsService, EmployeeDailyReportsService, ProductionDailyAlertsService, OutsourceLogisticsService, ProductionProgressService, FinishedGoodsQcService, FinishedGoodsInventoryService, FinishedGoodsOutboundService, MaterialSlipExportService] })
