...
@Module({ imports: [AuditModule], controllers: [ProductionMasterDataController, ProductionOrdersController, RawMaterialMovementsController, OperationDailyReportsController, EmployeeDailyReportsController, ProductionDailyAlertsController, OutsourceLogisticsController, ProductionProgressController, FinishedGoodsQcController, FinishedGoodsInboundNoticesController, WarehouseFinishedGoodsInboundNoticeController, FinishedGoodsInventoryController, FinishedGoodsOutboundController, ProductionPayrollExportController, MaterialSlipExportController], providers: [ProductionMasterDataService, ProductionOrdersService, RawMaterialMovementsService, OperationDailyReportsService, EmployeeDailyReportsService, ProductionDailyAlertsService, OutsourceLogisticsService, ProductionProgressService, FinishedGoodsQcService, FinishedGoodsInboundNoticesService, FinishedGoodsInventoryService, FinishedGoodsOutboundService, ProductionPayrollExportService, MaterialSlipExportService], exports: [ProductionMasterDataService, ProductionOrdersService, RawMaterialMovementsService, OperationDailyReportsService, EmployeeDailyReportsService, ProductionDailyAlertsService, OutsourceLogisticsService, ProductionProgressService, FinishedGoodsQcService, FinishedGoodsInboundNoticesService, FinishedGoodsInventoryService, FinishedGoodsOutboundService, MaterialSlipExportService] })
