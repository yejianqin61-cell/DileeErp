...
@Module({ imports: [AuditModule], controllers: [ProductionMasterDataController, ProductionOrdersController, RawMaterialMovementsController, OperationDailyReportsController, EmployeeDailyReportsController, ProductionDailyAlertsController, OutsourceLogisticsController, ProductionProgressController, FinishedGoodsQcController], providers: [ProductionMasterDataService, ProductionOrdersService, RawMaterialMovementsService, OperationDailyReportsService, EmployeeDailyReportsService, ProductionDailyAlertsService, OutsourceLogisticsService, ProductionProgressService, FinishedGoodsQcService], exports: [ProductionMasterDataService, ProductionOrdersService, RawMaterialMovementsService, OperationDailyReportsService, EmployeeDailyReportsService, ProductionDailyAlertsService, OutsourceLogisticsService, ProductionProgressService, FinishedGoodsQcService] })
