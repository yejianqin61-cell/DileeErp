...
import { MaterialIssueExportController } from "./material-issue-export.controller";
import { MaterialIssueExportService } from "./material-issue-export.service";

@Module({ imports: [AuditModule], controllers: [ProductionMasterDataController, ProductionOrdersController, RawMaterialMovementsController, OperationDailyReportsController, EmployeeDailyReportsController, ProductionDailyAlertsController, OutsourceLogisticsController, ProductionProgressController, FinishedGoodsQcController, FinishedGoodsInventoryController, FinishedGoodsOutboundController, ProductionPayrollExportController, MaterialIssueExportController], providers: [ProductionMasterDataService, ProductionOrdersService, RawMaterialMovementsService, OperationDailyReportsService, EmployeeDailyReportsService, ProductionDailyAlertsService, OutsourceLogisticsService, ProductionProgressService, FinishedGoodsQcService, FinishedGoodsInventoryService, FinishedGoodsOutboundService, ProductionPayrollExportService, MaterialIssueExportService], exports: [ProductionMasterDataService, ProductionOrdersService, RawMaterialMovementsService, OperationDailyReportsService, EmployeeDailyReportsService, ProductionDailyAlertsService, OutsourceLogisticsService, ProductionProgressService, FinishedGoodsQcService, FinishedGoodsInventoryService, FinishedGoodsOutboundService, MaterialIssueExportService] })
