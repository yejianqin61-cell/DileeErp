...
class UpdateMaterialDto { @IsOptional() @IsString() @MaxLength(80) material_code?: string; @IsOptional() @IsString() @MaxLength(200) name?: string; @IsOptional() @IsUUID() default_unit_id?: string; @IsOptional() @IsString() @MaxLength(30) material_type?: string; @IsOptional() @IsString() @MaxLength(1000) remark?: string | null; }
