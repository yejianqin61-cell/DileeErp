...
class SupplierDto { @IsOptional() @IsString() @MaxLength(80) supplier_code?: string; @IsOptional() @IsIn(["auto", "manual"]) code_mode?: string; @IsString() @MaxLength(200) name!: string; @IsOptional() @IsString() @MaxLength(100) contact_name?: string; @IsOptional() @IsString() @MaxLength(50) phone?: string; @IsOptional() @IsObject() settlement_info?: Record<string, unknown>; @IsOptional() @IsString() @MaxLength(1000) remark?: string; }
