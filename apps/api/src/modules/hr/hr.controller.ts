...
class UpdateAttendanceDto { @IsOptional() @IsDateString() attendance_date?: string; @IsOptional() @IsString() attendance_type?: string; @IsOptional() @IsString() work_hours?: string; @IsOptional() @IsString() overtime_hours?: string; @IsOptional() @IsArray() attachment?: unknown[]; @IsOptional() @IsString() remark?: string; }
