...
class PayLedgerDto { @IsString() amount!: string; @IsDateString() payment_date!: string; @IsString() payment_method!: string; @IsOptional() @IsString() currency?: string; @IsOptional() @IsString() remark?: string; }
