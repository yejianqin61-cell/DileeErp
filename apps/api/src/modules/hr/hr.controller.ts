...
class PayrollGenerateDto { @IsOptional() @IsUUID() employee_id?: string; @IsOptional() @IsString() employee_name?: string; @IsDateString() period_start!: string; @IsDateString() period_end!: string; @IsString() currency!: string; @IsOptional() @IsString() base_salary?: string; @IsOptional() @IsString() overtime_amount?: string; @IsOptional() @IsString() attendance_deduction?: string; @IsOptional() @IsString() performance_amount?: string; @IsOptional() @IsString() allowance_amount?: string; @IsOptional() @IsString() social_insurance?: string; @IsOptional() @IsString() individual_tax?: string; @IsOptional() @IsString() other_adjustment?: string; @IsOptional() @IsArray() attachment?: unknown[]; @IsOptional() @IsString() remark?: string; }
class PayrollUpdateDto { @IsOptional() @IsUUID() employee_id?: string; @IsOptional() @IsDateString() period_start?: string; @IsOptional() @IsDateString() period_end?: string; @IsOptional() @IsString() currency?: string; @IsOptional() @IsString() base_salary?: string; @IsOptional() @IsString() overtime_amount?: string; @IsOptional() @IsString() attendance_deduction?: string; @IsOptional() @IsString() performance_amount?: string; @IsOptional() @IsString() allowance_amount?: string; @IsOptional() @IsString() social_insurance?: string; @IsOptional() @IsString() individual_tax?: string; @IsOptional() @IsString() other_adjustment?: string; @IsOptional() @IsArray() attachment?: unknown[]; @IsOptional() @IsString() remark?: string; }
