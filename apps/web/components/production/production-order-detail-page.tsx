...
type Order = AuditRow & { id: string; productionOrderNo: string; orderNo: string; bomId?: string | null; bom?: { id: string } | null; executionMode: "in_house" | "outsourced"; status: string; plannedQuantity: string; unit?: { name?: string }; executionLocation?: { name?: string }; operations: Operation[] };
