...
export function DailyReportsPanel({ productionOrderId }: { productionOrderId?: string } = {}) {
  ...
  return (
    <section className="panel daily-report-panel" data-testid="daily-reports-panel">
      ...
      <Dialog open={Boolean(selectedOperation)} onOpenChange={(open) => { if (!open) closeDialog(); }}>
        <DialogContent className="daily-report-dialog" data-testid="operation-report-form">
          <DialogHeader>
