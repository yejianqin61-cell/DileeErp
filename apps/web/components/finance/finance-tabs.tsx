...
export function FinanceTabs({ basePath, tabs, active, query }: { basePath: string; tabs: ReadonlyArray<{ key: string; title: string }>; active: string; query?: Record<string, string> }) {
