...
export const ToastViewport = ({ className, ...props }: ComponentProps<typeof ToastPrimitive.Viewport>) => <ToastPrimitive.Viewport className={cn("ui-toast-viewport", className)} {...props} data-testid="toast-region" />;
export const Toast = ({ className, ...props }: ComponentProps<typeof ToastPrimitive.Root>) => <ToastPrimitive.Root className={cn("ui-toast", className)} {...props} data-testid="toast-item" />;
